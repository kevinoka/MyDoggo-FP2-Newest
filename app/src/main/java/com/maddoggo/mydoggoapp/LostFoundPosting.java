...
public class LostFoundPosting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lost_found_posting);
        ...
        rootLayoutLFP = findViewById(R.id.rootLayoutLFP);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.mybutton) {
            ...
            {
                Snackbar.make(rootLayoutLFP, "Dog name cannot be empty", Snackbar.LENGTH_SHORT)
                        .show();
                return false;
            }
            else if(TextUtils.isEmpty(editLFDogTypeLF.getText().toString())){
                Snackbar.make(rootLayoutLFP, "Dog type cannot be empty", Snackbar.LENGTH_SHORT)
                        .show();
                return false;
            }
            else if(TextUtils.isEmpty(editLFDogLastSeen.getText().toString())){
                Snackbar.make(rootLayoutLFP, "Last seen location cannot be empty", Snackbar.LENGTH_SHORT)
                        .show();
                return false;
            }
            else if(TextUtils.isEmpty(editLFChara.getText().toString())){
                Snackbar.make(rootLayoutLFP, "Dog characteristic cannot be empty", Snackbar.LENGTH_SHORT)
                        .show();
                return false;
            }
            else if(TextUtils.isEmpty(editLFPhone.getText().toString())){
                Snackbar.make(rootLayoutLFP, "Phone number cannot be empty", Snackbar.LENGTH_SHORT)
                        .show();
                return false;
            }
            else {
