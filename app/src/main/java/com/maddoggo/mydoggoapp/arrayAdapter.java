...
public class arrayAdapter extends ArrayAdapter<AdoptionCards> {

    Context context;

    public arrayAdapter(Context context, int resourceId, List<AdoptionCards> items) {
        super(context, resourceId, items);
    }

    public View getView(int position, View convertView, ViewGroup parent) {
        AdoptionCards card_item = getItem(position);
        ...
        dog_name.setText(card_item.getName());
